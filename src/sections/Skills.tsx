      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <div className="fade-in-up">
          ...
          {activeTab === "experience" && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-blue-600 mb-1">Feb 2022 – Present</p>
          ...
          {activeTab === "education" && (
            <div className="space-y-6">
              <div>
                <h5 className="text-xl font-semibold">STJIT College (VTU University)</h5>
                <hr className="border-blue-600 w-16 my-2" />
                <p className="text-blue-600 mb-1">2017 - 2021</p>
                <h6 className="font-medium">Bachelor of Computer Science</h6>
              </div>
            </div>
          )}
        </div>
