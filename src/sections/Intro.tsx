...
import profileImg from "../assets/profile.avif"; // Use your image
import splash from "../assets/splash.png"; // Use your background
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 h-full">
          ...
          >
            <h3 className="text-purple-600 text-xl sm:text-2xl font-semibold mb-2">I'm</h3>
            ...
            <a
              href="/Resume.pdf"
              download="Megha_Hiremath_Resume.pdf"
          ...
          >
            <img
              src={profileImg}
              alt="Profile"
              className="w-[280px] sm:w-[360px] md:w-[440px] lg:w-[500px] object-contain"
            />
          </motion.div>
