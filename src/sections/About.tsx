          ...
          <div className="mt-8">
            <div className="flex items-center mb-6">
              <div className="flex-shrink-0 text-center mr-6">
                <h1 className="text-6xl font-bold text-teal-400">3+</h1>
            ...
            I’m a full-stack developer with 3+ years of experience crafting responsive,
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="mt-2 text-gray-700">
              With over 3 years in frontend development, I've helped numerous clients build responsive and user-friendly web applications.
            </p>
          </div>
